...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        // 방향 계산
        var direction = new Vector2(playerInput.move.x, playerInput.move.y);
        ...
        {
            if (currentSpeed > walkSpeed && quickTurnTimeoutDelta <= 0.0f)
    ...
    bool BodyTurn()
    {
        ...
        if (Vector3.zero != direction && angle > quickTurnMinAngle - 10)
